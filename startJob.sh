...
curl -X POST ${URL}/jobrunner/rest/v1/job/${JOB_ID}/start --header "Content-Type:application/json" --header "X-Requested-By:DPMClient" --header "X-SS-REST-CALL:true" --header "X-SS-User-Auth-Token:$sessionToken"
